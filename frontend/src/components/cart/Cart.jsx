    ...
    return (
        <div className="border-b p-4">
            <div className="w-full flex items-center">
                ...
                <img src="https://bonik-react.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fproducts%2FFashion%2FAccessories%2F14.MVMTMWatchBlack.png&w=640&q=75" alt=""
                    className='w-[80px] h-[80px] ml-2' />
                <div className='pl-[5px]'>
                    <h1>{data.name}</h1>
                    <h4 className='font-[400] text-[15px] text-gray-600'>
                        ${data.price} * {value}
                    </h4>
